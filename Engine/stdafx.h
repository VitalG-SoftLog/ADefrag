/*
    ...
    Abstract:
        ...
        Defrag Engine Dll main header. 
        Include file for standard system and application include files.

    $Header: /home/CVS_DEFRAG/Defrag/Src/Engine/stdafx.h,v 1.3 2009/12/24 10:52:20 dimas Exp $
    $Log: stdafx.h,v $
...
#define DEFRAG_ENGINE_DLL

#define DECLSPEC_APP_IMPEX      __declspec(dllimport)
#define DECLSPEC_ENGINE_IMPEX   __declspec(dllexport)
...
} ENGINE_GLOBAL, *PENGINE_GLOBAL;

extern ENGINE_GLOBAL      Global;
